...
namespace TimeSheet.Models
{
    ...
    {
        public static Attachment CreateAttachment(Stream input, string displayName, TransferEncoding transferEncoding)
        {
            Attachment attachment = new Attachment(input, "application/vnd.ms-excel");
